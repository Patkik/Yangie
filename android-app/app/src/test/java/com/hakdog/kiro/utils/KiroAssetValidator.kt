...
class KiroAssetValidator {
    ...
    // Dynamic resolution of assets directory from module root or workspace root
    ...
    // The strict list of required files established in the Space Capsule modular blueprint
    ...
    fun verifyAssetDirectoryStructure() {
        ...
        requiredAssets.forEach { relativePath ->
            ...
            if (!file.exists()) {
                ...
                println(" [OK (Size: ${file.length()} bytes)]")
            }
        }
        ...
        println("All ${requiredAssets.size} Kiro modules are present and healthy! Ready to build.")
    }
